...
plot(x31control_cmdBlndVar.Time,x31control_cmdMG.data(:,2)*180/pi(),'--g'); hold on
...
sz = size(x31control_stateVelAng.Time);
plot(x31control_stateVelAng.Time(1), x31control_stateVelAng.Time(sz(1))] , [x31control_cmdVelAng.data(:,1),x31control_cmdVelAng.data(:,1)],'--r'); hold on
plot(x31control_stateVelAng.Time(1), x31control_stateVelAng.Time(sz(1))] , [x31control_cmdVelAng.data(:,2)*180/pi(),x31control_cmdVelAng.data(:,2)*180/pi()],'--g'); hold on
plot(x31control_stateVelAng.Time(1), x31control_stateVelAng.Time(sz(1))] , [x31control_cmdVelAng.data(:,3)*180/pi(),x31control_cmdVelAng.data(:,3)*180/pi()],'--b'); hold on
plot(x31control_stateVelAng.Time,x31control_stateVelAng.data(:,1),'r'); hold on
plot(x31control_stateVelAng.Time,x31control_stateVelAng.data(:,2)*180/pi(),'g'); hold on
plot(x31control_stateVelAng.Time,x31control_stateVelAng.data(:,3)*180/pi(),'b');
...
figure('name','Heading Vector V£q£^')
sz = size(x31control_stateVelAng.Time);
%plot(x31control_stateVelAng.Time, x31control_cmdVelAng.data(:,1),'--r'); hold on
%plot(x31control_stateVelAng.Time, x31control_cmdVelAng.data(:,2)*180/pi(),'--g'); hold on
%plot(x31control_stateVelAng.Time, x31control_cmdVelAng.data(:,3)*180/pi(),'--b'); hold on
plot(x31control_stateVelAng.Time,x31control_stateVelAng.data(:,1),'r'); hold on
plot(x31control_stateVelAng.Time,x31control_stateVelAng.data(:,2)*180/pi(),'g'); hold on
plot(x31control_stateVelAng.Time,x31control_stateVelAng.data(:,3)*180/pi(),'b');
legend('V_{cmd}','£q_{cmd}','£^_{cmd}','V','£q','£^');
...
plot(x31control_cmdBlndVar.Time,x31control_cmdBlndVar.data(:,1),'--r'); hold on
plot(x31control_cmdBlndVar.Time,x31control_cmdMG.data(:,3)*180/pi(),':g'); hold on
plot(x31control_cmdBlndVar.Time,x31control_cmdBlndVar.data(:,2)*180/pi(),'--g'); hold on
plot(x31control_cmdBlndVar.Time,x31control_cmdBlndVar.data(:,3),'--b'); hold on
plot(x31control_cmdBlndVar.Time,x31control_stateBlndVar.data(:,1),'r'); hold on
plot(x31control_cmdBlndVar.Time,x31control_stateBlndVar.data(:,2)*180/pi(),'g'); hold on
plot(x31control_cmdBlndVar.Time,x31control_stateBlndVar.data(:,3),'b');
